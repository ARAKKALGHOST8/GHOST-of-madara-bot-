...
cmd({
  ...
  try {
    ...
    const caption = `╭═══ 〔 *GHOST Of MADARA 𝐀𝐏𝐊* 〕═══❐
┃ 🏷️ *ɴᴀᴍᴇ:* ${app.name}
┃ 📦 *sɪᴢᴇ:* ${appSize} MB
┃ 📮 *ᴘᴀᴄᴋᴀɢᴇ:* ${app.package}
...
╰══════════════════❐
> *Powered by your GHOST Of MADARA🎐*`;
  ...
  try {
    ...
    if (downloadUrl) {
      ...
      await conn.sendMessage(from, {
        ...
        caption: "> *Powered by your GHOST Of MADARA 🎐*"
      }, { quoted: m });
